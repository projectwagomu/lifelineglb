...
public class SyntheticTaskDeque extends AbstractCollection<SyntheticTask>
  ...
  private void doubleCapacity() {
    ...
    SyntheticTask[] a = new SyntheticTask[newCapacity];
  ...
  public Spliterator<SyntheticTask> spliterator() {
    return new DeqSpliterator<SyntheticTask>(this, -1, -1);
  }
  ...
  public SyntheticTask[] getFromFirst(int n) {
    ...
    SyntheticTask[] result = this.peekFromFirst(toCopy);
    if (toCopy == this.size()) {
      //            this.size = 0;
      this.head = 0;
      this.tail = 0;
  ...
  public SyntheticTask[] getFromLast(int n) {
    ...
    SyntheticTask[] result = this.peekFromLast(toCopy);
    if (toCopy == this.size()) {
      this.head = 0;
      this.tail = 0;
    } else {
  ...
  private void normalize() {
    ...
    SyntheticTask[] newElements = new SyntheticTask[n];
  ...
  public void pushArrayLast(SyntheticTask[] elements) {
    this.normalize();
    SyntheticTask[] oldElements = this.elements;
  ...
  static final class DeqSpliterator<SyntheticTask> implements Spliterator<SyntheticTask> {
    ...
    public DeqSpliterator<SyntheticTask> trySplit() {
      ...
      if (h != t && ((h + 1) & (n - 1)) != t) {
        ...
        int m = ((h + t) >>> 1) & (n - 1);
        return new DeqSpliterator<SyntheticTask>(deq, h, index = m);
      }
      return null;
    }
