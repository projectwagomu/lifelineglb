...
public class Graph implements Serializable {
	...
	/**
	 * Add an edge. We do not check if the edge exists! If an edge exists, its
	 * overwritten.
	 */
	...
	/**
	 * Give the position of the beginning of my neighbors in the compressed notation
	 * of the graph. This means that the compression must represent the graph in the
	 * CSR format.
	 */
	...
	/**
	 * Create the compressed representation. To be called only after all the edges
	 * have been added to the vertex list. All we are doing here is iterating over
	 * all the edges over all the vertices and populating the offsetMap and the
	 * adjacencyMap.
	 */
	 ...
	 * vertex'timestamps neighbor list end. The iteration space is therefore [begin,
	 * end).
	 */
