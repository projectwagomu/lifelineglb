...
import static apgas.Constructs.closeSocket;
...
import static apgas.Constructs.receiveSchedulerMessage;
import static apgas.Constructs.sendRemovedHosts;
  ...
  private List<Integer> malleabilityStartNewPlaces(
    ...
    for (final Place newPlace : newListPlaces) {
      immediateAsyncAt(
          newPlace,
          () -> {
            final GLBcomputer glBcomputer = new GLBcomputer<R, B>();
