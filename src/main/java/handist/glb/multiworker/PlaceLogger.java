...
public class PlaceLogger implements Serializable {
  ...
  public PlaceLogger(int placeId) {
    place = placeId;
    time = new long[GLBMultiWorkerConfiguration.GLB_MULTIWORKER_WORKERPERPLACE.get() + 1];
    timeStealing = new long[GLBMultiWorkerConfiguration.GLB_MULTIWORKER_WORKERPERPLACE.get() + 1];
  }
